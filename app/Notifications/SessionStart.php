...
class SessionStart extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('La séance de sport du ' . optional($this->session)->session_date . ' a été lancée.')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'title' => 'Séance lancée',
            'message' => 'La séance du ' . optional($this->session)->session_date . ' a été lancée.',
